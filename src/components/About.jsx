...
const About = () => {
  return (
    <section
      id="about"
      className="w-full flex flex-col bg-[rgba(0,0,0,0.87)] py-5 space-y-10 md:p-10 md:px-16 md:space-y-16"
    >
      ...
      <div className="flex flex-col space-y-5 px-5 md:flex-row md:space-y-0 md:space-x-10">
        ...
        <div className="flex flex-col space-y-2 md:w-1/3">
          ...
          <motion.a
            ...
            href="/elijah_CV.pdf"
            className="w-fit bg-green-400 px-7 py-[10px] rounded-full shadow-md text-lg text-white font-bold hover:bg-green-500"
          >
            Download CV
          </motion.a>
        </div>
