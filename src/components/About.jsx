...
const About = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-5 px-5 md:flex-row md:space-y-0 md:space-x-24">   
        <div className="text-white text-center space-y-5 md:text-start md:w-[57%] md:space-y-7">
        ...
        <div className="flex flex-col space-y-2 md:w-[30%]">
      ...
      <div className="grid grid-cols-2 grid-rows-2 px-5 md:flex md:px-20 md:justify-center">
        <div className="flex flex-col pt-2 justify-center items-center border-r border-b border-[rgba(154,152,152,0.58)] border-dotted md:border-b-0 md:pt-0 md:p-5 md:border-r-0 md:w-[500px] md:py-5 md:px-10">
          <h1 className="text-[42px] p-2 text-gray-400 font-bold text-6xl">
            5+
          </h1>
          <p className="text-xl text-gray-200 pb-2 px-1">Years Experience</p>
        </div>
        <div className="flex flex-col pt-2 justify-center items-center border-b border-[rgba(154,152,152,0.58)] border-dotted md:border-b-0 md:pt-0 md:p-5 md:border-l md:w-[500px] md:py-5 md:px-10">
          <h1 className="text-[42px] p-2 text-gray-400 font-bold text-6xl">
            17+
          </h1>
          <p className="text-xl text-gray-200 pb-2 px-1">Happy Clients</p>
        </div>
        <div className="flex flex-col pt-2 justify-center items-center border-r border-[rgba(154,152,152,0.58)] border-dotted md:border-b-0 md:pt-0 md:p-5 md:border-l md:w-[500px] md:py-5 md:px-10">
          <h1 className="text-[42px] p-2 text-gray-400 font-bold text-6xl">
            50+
          </h1>
          <p className="text-xl text-gray-200 pb-2 px-1">Projects Done</p>
        </div>
        <div className="flex flex-col pt-2 justify-center items-center border-[rgba(154,152,152,0.58)] border-dotted md:border-b-0 md:pt-0 md:p-5 md:border-r-0 md:w-[500px] md:py-5 md:px-10">
          <h1 className="text-[42px] p-2 text-gray-400 font-bold text-6xl">
            8+
          </h1>
